        ...
        {loading ? (
          ...
          <div className="space-y-8">
            {requests.map((request) => (
              <div
                key={request._id}
                className="bg-white rounded-xl h-[500px] md:min-h-[650px] shadow-lg border border-gray-200 overflow-hidden hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
                <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-3 md:gap-2 items-start">

                  <div className="bg-green-50 p-3 md:p-5 md:h-35 md:w-390 border-b border-green-100 rounded-t-xl">
                ...
                <div className="flex justify-center gap-2 mt-4 md:gap-8 md:py-2 ">
                  ...
                  {/* Requested Product */}
                  <div className="border border-gray-200 w-42 h-70 md:w-132 md:h-[390px] md:p-4 -mt-2 md:mt-0 rounded-xl hover:shadow-xl transition-all duration-300">
                    ...
                    <img
                      ...
                      className="w-36 h-36 md:w-125 md:rounded-none md:h-54 object-cover md:ml-0 ml-3 md:mx-auto rounded-lg cursor-pointer"
                    />
                ...
                {request.status === "pending" && (
                  <div className="flex justify-center gap-2 md:gap-4 mt-5 md:mt-6 pb-4">
                    <button
                      ...
                      className="w-36 md:w-40 bg-[#2E7D32] hover:bg-[#256728] text-white py-2 md:py-3 rounded-xl transition font-medium"
                    >
                      Accept
                    </button>
                    ...
                    <button
                      ...
                      className="w-36 md:w-40 bg-red-500 hover:bg-red-600 text-white py-2 md:py-3 rounded-xl transition font-medium"
                    >
                      Reject
                    </button>
                  </div>
